...
data3 %>%
  ...
  geom_boxplot() +
  theme_minimal() +
  labs(title = "Loan Success vs. Mortgage Insurance Percentage", x = "Mortgage Insurance Percentage", y = "Count") +
  scale_color_discrete(name="Loan Success") +
  ggeasy::easy_center_title()
```
...
data3 %>%
  ggplot(aes(x = as.factor(good_loan), y = log(NUM_UNIT), color = as.factor(good_loan))) +
  geom_boxplot() +
  theme_minimal() +
  labs(title = "Loan Success vs. Number of Units", x = "Number of Units", y = "Count") +
  scale_color_discrete(name="Loan Success") +
  ggeasy::easy_center_title()
```
